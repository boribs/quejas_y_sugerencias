...
INSERT INTO Publicacion (Tipo, Id_Usuario, Titulo, Comentario, Fecha, Id_Area, Resuelto, Anonimo)
VALUES ((SELECT Id FROM Tipo_Publicacion WHERE Nombre = "Queja"), 3, "Bancas en la explanada entre CCO1 y CCO2", "Estaría muy bien si se colocaran bancas entre los salones CCO1 y CCO2, aprovechando el espacio que hay que no se usa.", '2023-02-13', 2, FALSE, FALSE);
INSERT INTO Publicacion (Tipo, Id_Usuario, Titulo, Comentario, Fecha, Id_Area, Resuelto, Anonimo)
